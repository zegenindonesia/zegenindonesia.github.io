...
function (_madxartworkModules$Mod) {
  (0, _inherits2.default)(BaseComponent, _madxartworkModules$Mod);
  ...
  (0, _createClass2.default)(BaseComponent, [{
    ...
    value: function onRoute(route) {
      madxartworkCommon.elements.$body.addClass(this.getBodyClass(route));
      this.activate();
    ...
    value: function onCloseRoute(route) {
      madxartworkCommon.elements.$body.removeClass(this.getBodyClass(route));
      this.inactivate();
...
function (_Base) {
  ...
  (0, _createClass2.default)(History, [{
     ...
     *
     * Return `madxartwork.history.history.getActive()`.
     *
     * @returns {boolean}
     */
    ...
    value: function onCatchApply(e) {
      ...
      if (e instanceof madxartworkModules.common.HookBreak && this.historyId) {
...
function (_ArgsObject) {
  ...
  /**
   * Current component (madxartworkModules.Module ).
   *
   * @type {{}}
   */
  ...
  (0, _createClass2.default)(Base, [{
    ...
    value: function requireContainer() {
      ...
      containers.forEach(function (container) {
        _this2.requireArgumentInstance('container', madxartworkModules.editor.Container, {
          container: container
        });
      });
    }
    ...
    value: function run() {
      ...
      try {
        ...
        if (e instanceof madxartworkModules.common.HookBreak) {
          return false;
        }
      } // For $e.hooks.
...
function () {
  ...
  (0, _createClass2.default)(Helpers, null, [{
    ...
    value: function findViewById(id) {
      var elements = Helpers.findViewRecursive(madxartwork.getPreviewView().children, 'id', id, false);
    ...
    value: function isValidChild(childModel, parentModel) {
      ...
      var childTypes = madxartwork.helpers.getElementChildType(parentElType);
    ...
    value: function isPasteEnabled(targetContainer) {
      var storage = madxartworkCommon.storage.get('clipboard'); // No storage? no paste.
  ...
  (0, _createClass2.default)(Create, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        ...
        model: model,
        type: 'add',
        title: madxartwork.helpers.getModelLabel(model)
      };
    }
  }, {
    key: "apply",
...
var getDefaultDebounceDelay = function getDefaultDebounceDelay() {
  ...
  if (madxartworkConfig.document && undefined !== madxartworkConfig.document.debounceDelay) {
    result = madxartworkConfig.document.debounceDelay;
  }
...
function (_History) {
  ...
  (0, _createClass2.default)(Debounce, [{
    ...
    value: function onCatchApply(e) {
      ...
      if (e instanceof madxartworkModules.common.HookBreak && this.history) {
        if (this.isDebounceRequired) {
...
function (_History) {
  ...
  (0, _createClass2.default)(DisableEnable, [{
    ...
    value: function getHistory(args) {
      ...
      var subTitle = madxartwork.translate('dynamic') + ' ' + _settings.default.getSubTitle(args),
          type = this.type;
  ...
  (0, _createClass2.default)(Copy, [{
    ...
    value: function apply(args) {
      var _args$storageKey = args.storageKey,
          ...
          _args$containers = args.containers,
          containers = _args$containers === void 0 ? [args.container] : _args$containers;
      madxartworkCommon.storage.set(storageKey, containers.map(function (container) {
  ...
  (0, _createClass2.default)(CopyAll, [{
    ...
    value: function apply() {
      $e.run('document/elements/copy', {
        containers: (0, _values.default)(madxartwork.getPreviewView().children._views).map(function (view) {
  ...
  (0, _createClass2.default)(Delete, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        ...
        madxartwork.channels.data.trigger('element:before:remove', container.model);
        container.model.destroy(); // BC: Deprecated since 2.8.0 - use `$e.events`.

        madxartwork.channels.data.trigger('element:after:remove', container.model);
        container.panel.refresh();
      });
...
function (_History) {
  ...
  (0, _createClass2.default)(Empty, [{
    ...
    value: function getHistory(args) {
      if (args.force) {
        return {
          ...
          data: madxartwork.elements ? madxartwork.elements.toJSON() : null,
          restore: this.constructor.restore
        };
      }
    ...
    key: "apply",
    value: function apply(args) {
      if (args.force && madxartwork.elements) {
        madxartwork.elements.reset();
        madxartwork.getPreviewContainer().panel.closeEditor();
        return;
      }

      madxartwork.getClearPageDialog().show();
    }
  }, {
    key: "isDataChanged",
    value: function isDataChanged() {
    ...
    value: function restore(historyItem, isRedo) {
      if (isRedo) {
        ...
        if (data) {
          madxartwork.getPreviewView().addChildModel(data);
        }
      }
    }
  }]);
...
function (_History) {
  ...
  (0, _createClass2.default)(Import, [{
    ...
    key: "apply",
    value: function apply(args) {
      var previewContainer = madxartwork.getPreviewContainer(),
          data = args.data,
          _args$options = args.options,
...
function (_History) {
  ...
  (0, _createClass2.default)(Paste, [{
    ...
    value: function validateArgs(args) {
      ...
      var _args$storageKey = args.storageKey,
          storageKey = _args$storageKey === void 0 ? 'clipboard' : _args$storageKey,
          storageData = madxartworkCommon.storage.get(storageKey);
...
function (_History) {
  ...
  (0, _createClass2.default)(Move, [{
    ...
    value: function validateArgs(args) {
      this.requireContainer(args);
      this.requireArgumentInstance('target', madxartworkModules.editor.Container, args);
    }
  }, {
    key: "getHistory",
    value: function getHistory(args) {
      ...
      containers.forEach(function (targetContainer) {
        ...
        storageData.forEach(function (sourceModel) {
          ...
          (0, _entries.default)(targetControls).forEach(function (_ref) {
            ...
            if (controlSourceValue === controlTargetValue || !madxartwork.getControlView(control.type).onPasteStyle(control, controlSourceValue)) {
              return;
            }
          ...
          madxartwork.channels.data.trigger('element:before:paste:style', targetContainer.model);
          $e.run('document/elements/settings', {
            container: targetContainer,
          ...
          madxartwork.channels.data.trigger('element:after:paste:style', targetContainer.model);
  ...
  (0, _createClass2.default)(ResetStyle, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        ...
        madxartwork.channels.data.trigger('element:before:reset:style', container.model);
        $e.run('document/elements/settings', {
          container: container,
          settings: defaultValues
        }); // BC: Deprecated since 2.8.0 - use `$e.events`.

        madxartwork.channels.data.trigger('element:after:reset:style', container.model);
...
madxartworkCommon.elements.$window.on('madxartwork:init', function () {
...
function () {
  function BackwardsCompatibility() {
    ...
    madxartworkCommon.elements.$window.on('madxartwork:init', this.deprecatedEvents);
    madxartwork.channels.data.on('template:before:insert', this.startInsertTemplate).on('template:after:insert', this.endItem);
  }

  (0, _createClass2.default)(BackwardsCompatibility, [{
    key: "deprecatedEvents",
    value: function deprecatedEvents() {
      var madxartworkDataEvents = madxartwork.channels.data._events,
      ...
      deprecatedEvents.forEach(function (event) {
        if (madxartworkDataEvents[event] && madxartworkDataEvents[event].length) {
          madxartworkCommon.helpers.softDeprecated("event: ".concat(event), '2.8.0', '$e.events');
        }
      });
    }
  }, {
    ...
    value: function startInsertTemplate(model) {
      madxartworkCommon.helpers.softDeprecated('event: template:before:insert', '2.8.0', "$e.run( 'document/import' )");
...
function (_HookDependency) {
  ...
  (0, _createClass2.default)(IsPasteStyleEnabled, [{
    ...
    key: "apply",
    value: function apply() {
      return madxartwork.getCurrentElement().pasteStyle && madxartworkCommon.storage.get('clipboard');
    }
  }]);
    ...
    value: function apply(args) {
      ...
      container) {
        if ('dynamic' === container.type) {
          var tagText = madxartwork.dynamicTags.tagContainerToTagText(container),
              commandArgs = {
  ...
  (0, _createClass2.default)(ResizeColumn, [{
    ...
    value: function resizeColumn(container, newSize) {
      ...
      var parentView = container.parent.view,
          ...
          totalWidth = parentView.$el.find(' > .madxartwork-container')[0].getBoundingClientRect().width;
      ...
      $e.run('document/elements/settings', {
        ...
        options: {
          ...
          history: {
            title: madxartwork.config.elements.column.controls._inline_size.label
          },
          external: true,
          debounce: true
        }
...
function (_Base) {
  ...
  (0, _createClass2.default)(Copy, [{
    key: "apply",
    value: function apply(args) {
      var selectedElement = madxartwork.getCurrentElement();
...
function (_Base) {
  ...
  (0, _createClass2.default)(Paste, [{
    ...
    value: function initialize(args) {
      ...
      this.storage = madxartworkCommon.storage.get('clipboard');
      this.storage = this.storage.map(function (model) {
        return new Backbone.Model(model);
      });

      if (!containers[0]) {
        this.target = madxartwork.getCurrentElement();
  ...
  (0, _createClass2.default)(Duplicate, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        containers: containers,
        type: 'duplicate',
        subTitle: madxartwork.translate('Item')
      };
    }
  }, {
    key: "apply",
...
function (_History) {
  ...
  (0, _createClass2.default)(Insert, [{
    ...
    value: function initialize(args) {
      ...
      if (!args.model._id) {
        args.model._id = madxartwork.helpers.getUniqueID();
      }
    }
  }, {
    key: "validateArgs",
...
function (_History) {
  ...
  (0, _createClass2.default)(Move, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        var collection = container.settings.get(name),
            model = madxartworkCommon.helpers.cloneObject(collection.at(sourceIndex));
        $e.run('document/repeater/remove', {
          container: container,
          name: name,
          index: sourceIndex
  ...
  (0, _createClass2.default)(Component, [{
    ...
    value: function getCommands() {
      return {
        ...
        undo: function undo() {
          return madxartwork.history.history.navigate();
        },
        redo: function redo() {
          return madxartwork.history.history.navigate(true);
        }
      };
    }
  }, {
    ...
    value: function normalizeLogTitle(args) {
      ...
      if (!args.title && containers[0]) {
        if (1 === containers.length) {
          ...
          args.title = madxartwork.translate('elements');
        }
      }
...
function (_Base) {
  ...
  (0, _createClass2.default)(AddTransaction, [{
    key: "apply",
    value: function apply(args) {
      var currentId = madxartwork.history.history.getCurrentId();
...
function (_Base) {
  ...
  (0, _createClass2.default)(DeleteLog, [{
    ...
    value: function apply(args) {
      if (args.id) {
        madxartwork.history.history.deleteItem(args.id);
      }
    }
  }]);
  return DeleteLog;
...
function (_Base) {
  ...
  (0, _createClass2.default)(EndLog, [{
    ...
    value: function apply(args) {
      if (args.id) {
        madxartwork.history.history.endItem(args.id);
      }
    }
  }]);
  return EndLog;
...
function (_Base) {
  ...
  (0, _createClass2.default)(LogSubItem, [{
    ...
    value: function apply(args) {
      ...
      var id = args.id || madxartwork.history.history.getCurrentId();
      args = this.component.normalizeLogTitle(args);
      var items = madxartwork.history.history.getItems(),
...
function (_Base) {
  ...
  (0, _createClass2.default)(StartLog, [{
    key: "initialize",
    value: function initialize(args) {
      if (madxartwork.history.history.isItemStarted() || args.id) {
        this.isSubItem = true;
        return;
      }
    ...
    value: function apply(args) {
      ...
      return madxartwork.history.history.startItem(args);
    }
  }]);
  return StartLog;
}(_base.default);
