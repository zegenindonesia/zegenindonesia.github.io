...
/* global jQuery, madxartworkGutenbergSettings */
(function ($) {
  'use strict';

  var madxartworkGutenbergApp = {
    cacheElements: function cacheElements() {
      this.ismadxartworkMode = madxartworkGutenbergSettings.ismadxartworkMode;
      this.cache = {};
      this.cache.$gutenberg = $('#editor');
      this.cache.$switchMode = $($('#madxartwork-gutenberg-button-switch-mode').html());
      this.cache.$gutenberg.find('.edit-post-header-toolbar').append(this.cache.$switchMode);
      this.cache.$switchModeButton = this.cache.$switchMode.find('#madxartwork-switch-mode-button');
      this.toggleStatus();
      this.buildPanel();
      var self = this;
      ...
      self.cache.$switchModeButton.on('click', function () {
        if (self.ismadxartworkMode) {
          madxartworkCommon.dialogsManager.createWidget('confirm', {
            message: madxartworkAdmin.translate('back_to_wordpress_editor_message'),
            headerMessage: madxartworkAdmin.translate('back_to_wordpress_editor_header'),
            strings: {
              confirm: madxartworkAdmin.translate('yes'),
              cancel: madxartworkAdmin.translate('cancel')
            },
