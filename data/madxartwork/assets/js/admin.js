...
(function ($) {
  var madxartworkAdmin = madxartworkModules.ViewModule.extend({
    ...
    bindEvents: function bindEvents() {
      ...
      $('div.notice.madxartwork-message-dismissed').on('click', 'button.notice-dismiss, .madxartwork-button-notice-dismiss', function (event) {
        event.preventDefault();
        $.post(ajaxurl, {
          action: 'madxartwork_set_admin_notice_viewed',
          notice_id: $(this).closest('.madxartwork-message-dismissed').data('notice_id')
        });
        var $wrapperElm = $(this).closest('.madxartwork-message-dismissed');
        ...
        madxartworkCommon.dialogsManager.createWidget('confirm', {
          ...
          onConfirm: function onConfirm() {
            ...
            $.post(ajaxurl, $updateButton.data()).done(function (response) {
              ...
              $('#madxartwork_upgrade_fa_button').parent().append(response.data.message);
  ...
  $(function () {
    ...
    madxartworkCommon.elements.$window.trigger('madxartwork/admin/init');
  });
})(jQuery);
