        ...
        if (!modal) {
          modal = madxartworkCommon.dialogsManager.createWidget('lightbox', {
            ...
            onReady: function onReady() {
              ...
              this.addButton({
                name: 'submit',
                text: madxartworkAdmin.translate('submit_n_deactivate'),
                callback: self.sendFeedback.bind(self)
              });

              if (!madxartworkAdmin.config.feedback.is_tracker_opted_in) {
                this.addButton({
                  name: 'skip',
                  text: madxartworkAdmin.translate('skip_n_deactivate'),
