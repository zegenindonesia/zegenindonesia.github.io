...
function (_madxartworkModules$Vie) {
  ...
  function madxartworkCommonApp() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(madxartworkCommonApp).apply(this, arguments));
  }
...
function () {
  ...
  (0, _createClass2.default)(Helpers, [{
    ...
    value: function deprecatedMethod(methodName, version, replacement) {
      ...
      var style = "font-size: 12px; background-image: url(\"".concat(madxartworkCommon.config.urls.assets, "images/logo-icon.png\"); background-repeat: no-repeat; background-size: contain;");
...
function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function initialize() {
      ...
      this.collection = new Backbone.Collection((0, _values.default)(madxartworkCommon.finder.getSettings('data')));
    }
  }, {
    key: "activateItem",
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function addPopupPlugin() {
      jQuery.fn.madxartworkConnect = function (options) {
        ...
        madxartworkCommon.elements.$window.on('madxartworkConnected', settings.callback);
        return this;
      };
    }
  }, {
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          connectPopup: '.madxartwork-connect-popup'
        }
      };
    }
  }, {
    ...
    value: function applyPopup() {
      this.elements.$connectPopup.madxartworkConnect();
    }
  }, {
    key: "onInit",
    value: function onInit() {
  ...
  (0, _createClass2.default)(BackwardsCompatibility, [{
    ...
    value: function ensureTab(namespace, tabSlug) {
      ...
      if (!component) {
        ...
        /*#__PURE__*/
        function (_madxartworkModules$com) {
          (0, _inherits2.default)(Component, _madxartworkModules$com);
