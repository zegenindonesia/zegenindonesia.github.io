(function ($) {
	...
	/**
	 * Essential Addons For madxartwork
	 * 
	 * @use Frontend script file.
	 * @link https://essential-addons.com/madxartwork/
	 * --------------------------------------------------------
	 *  ================== Table Of Contents ==================
	 * --------------------------------------------------------
	 * //
	...
	var AdvGoogleMap = function($scope, $) {
		...
		if(!window.eaelHasMapAPI ) {
			...
			$map_notice.html('Whoops! It\' seems like you didn\'t set Google Map API key. You can set from <b>madxartwork > Essential Addons > Elements > Advanced Google Map (Settings)</b>');
	...
	var EaelParticlesHandler = function($scope,$){
		...
		function generateEditorSettings(targetId){
			...
			$.each(editorElements.models,function(index,elem){
				...
				} else if( elem.id == target.closest( '.madxartwork-top-section' ).data( 'id' ) ) {
  ...
  /*=================================*/
	...
	$(window).on('madxartwork/frontend/init', function () {
		if ( madxartworkFrontend.isEditMode() ) { isEditMode = true; }

		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-toggle.default', ToggleHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-counter.default', CounterHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-flip-carousel.default', FlipCarousel);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-filterable-gallery.default', filterableGalleryHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-dynamic-filterable-gallery.default', DynamicFilterableGallery);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-instafeed.default', InstagramGallery);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-adv-accordion.default', AdvAccordionHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-google-map.default', AdvGoogleMap);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-adv-tabs.default', AdvanceTabHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-post-timeline.default', postTimelineHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-post-list.default', postListHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-data-table.default', dataTable);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-content-timeline.default', contentTimelineHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-team-member-carousel.default', TeamMemberCarouselHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-image-hotspots.default', ImageHotspotHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-logo-carousel.default', LogoCarouselHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-post-carousel.default', PostCarouselHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-post-block.default', PostBlockHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-facebook-feed-carousel.default', FacebookCarouselHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-facebook-feed.default', FacebookFeedHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-twitter-feed.default', TwitterFeedHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-twitter-feed-carousel.default', TwitterFeedCarouselHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-testimonial-slider.default', TestimonialSliderHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-content-ticker.default', ContentTicker);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-image-comparison.default', ImageComparisonHandler);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-mailchimp.default', MailChimp);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-lightbox.default', LightBox);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-countdown.default', CountDown);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-fancy-text.default', FancyText);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-image-accordion.default', ImageAccordion);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-interactive-card.default', InteractiveCard);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-pricing-table.default', PricingTooltip);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-progress-bar.default', ProgressBar);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/eael-offcanvas.default', EaelOffcanvas);

		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/section', EaelParticlesHandler );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/section', EaelParallaxHandler );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.default', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.skin-one', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.skin-two', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.skin-three', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.skin-four', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.skin-five', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.skin-six', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-advanced-menu.skin-seven', AdvancedMenu );
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/eael-image-scroller.default', ImageScroller );
	});
